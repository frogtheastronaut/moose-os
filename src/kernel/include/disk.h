...
// ATA/IDE Controller Primary/Secondary channels
...
// Function prototypes
void disk_init(void);
// Return codes: 0=success, -1=invalid drive, -2=timeout waiting for ready, 
// -3=command error, -4=timeout waiting for data, -5=timeout waiting for completion, -6=write error
